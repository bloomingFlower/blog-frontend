...
const Comment = ({ comment, onReply, onVote, onDelete, postId, depth = 0 }) => {
  ...
  const onEmojiClick = (emojiObject, event) => {
    ...
    setIsVoting(true);
    onVote(postId, comment.ID, emojiObject.emoji)
      .then(() => {
        setIsVoting(false);
  ...
  return (
    <div
      className={`border-l-2 border-gray-200 pl-2 sm:pl-4 mb-2 sm:mb-4 ${
        ...
        <div className="flex-grow">
          <p
            className={`text-sm sm:text-base ${
              !comment.user_id ? "italic text-gray-500" : ""
            }`}
          >
            {displayName}
          </p>
          ...
          <div className="flex flex-wrap gap-1 sm:gap-2 mb-2">
            ...
            <div className="relative">
              <button
                ...
                className="emoji-button text-gray-500 hover:text-gray-700 text-sm sm:text-base flex items-center border rounded px-2 py-1 bg-gray-50 hover:bg-gray-100"
                disabled={isVoting}
              >
                {isVoting ? (
                  <svg
                  ...
                  >
                    ...
                    <path
                      fillRule="evenodd"
                      d="M7 9a1 1 0 11-2 0 1 1 0 012 0zm8 0a1 1 0 11-2 0 1 1 0 012 0zm-6.646 4.646a.5.5 0 01.708 0l.646.647.646-.647a.5.5 0 01.708.708l-1 1a.5.5 0 01-.708 0l-1-1a.5.5 0 010-.708z"
                      clipRule="evenodd"
                    />
                  </svg>
                )}
