...
// Create a new context for the hamburger menu
...
function AppContent() {
  ...
  // Create a function to toggle the hamburger menu
  const toggleHamburger = () => {
    setIsHamburgerOpen(prev => !prev);
  };

  return (
    <HamburgerContext.Provider value={{ isHamburgerOpen, toggleHamburger }}>
